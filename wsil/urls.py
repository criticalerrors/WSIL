...
urlpatterns = [
    ...
    url(r'^api/interest_time_fw/(?P<pk>[0-9]+)$', views.InterestOverTimeFw.as_view(), name="iot_fw"),
    url(r'^api/interest_region_fw/(?P<pk>[0-9]+)$', views.InterestByRegionFw.as_view(), name="ibr_fw")
]
